...
namespace Peio::Gfx {
	...
	void PipelineState::Init(D3D12_INPUT_LAYOUT_DESC inputLayout, ID3D12RootSignature* rootSignature, D3D12_SHADER_BYTECODE vertexShader, D3D12_SHADER_BYTECODE pixelShader, bool useBlend, bool useDepth, D3D12_PRIMITIVE_TOPOLOGY_TYPE topologyType)
	{
