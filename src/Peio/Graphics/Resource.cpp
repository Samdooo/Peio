...
namespace Peio::Gfx {
	...
	void Resource::Init(D3D12_RESOURCE_DESC resourceDesc, D3D12_RESOURCE_STATES resourceState, bool copyFootprints)
	{
		Release();
	...
	void Resource::Upload(const D3D12_SUBRESOURCE_DATA& data, ID3D12GraphicsCommandList* cmdList)
	{
